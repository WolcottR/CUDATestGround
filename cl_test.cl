...
int main()
{
    ...
    // platform 1 is NVIDIA GPU for me
    ...
    // using device[1] because that's a GPU; device[0] is the CPU
    ...
    cl::Event event;
    queue.enqueueNDRangeKernel(simple_add, cl::NullRange, cl::NDRange(10), cl::NullRange, NULL, &event);
